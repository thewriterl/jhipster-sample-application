package co.truvs.repository;

import co.truvs.JhipsterSampleApplicationApp;
import co.truvs.config.Constants;
import co.truvs.config.audit.AuditEventConverter;
import co.truvs.domain.PersistentAuditEvent;
...
import static co.truvs.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
